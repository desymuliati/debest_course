<x-app-layout>
    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          @endif
          <form class="w-full" action="{{ route('admin.materi.store') }}" method="post">
            @csrf
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="{{ old('deskripsi') }}" name="deskripsi"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div id="link-embed-container">
                  <input value="{{ old('link_embed_materi.0') }}" name="link_embed_materi[]"
                         class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                         type="url" placeholder="https://contoh.com/video">
                </div>
                <button type="button" id="add-link" class="mt-2 px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-700">
                  Tambah Link
                </button>
                <div class="mt-2 text-sm text-gray-500">
    ...
    <script>
      document.getElementById('add-link').addEventListener('click', function() {
        const container = document.getElementById('link-embed-container');
        const inputCount = container.getElementsByTagName('input').length;
        const newInput = document.createElement('input');
        newInput.type = 'url';
        newInput.name = `link_embed_materi[${inputCount}]`;
        newInput.placeholder = 'https://contoh.com/video';
        newInput.className = 'block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500 mt-2';
